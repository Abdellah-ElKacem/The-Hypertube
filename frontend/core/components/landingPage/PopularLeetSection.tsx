...
interface PopularLeetSectionProps {
    shuffledLeet: Movie[];
    handleMovieClick: (movieId: string | undefined) => void;
}

export default function PopularLeetSection({ shuffledLeet, handleMovieClick }: PopularLeetSectionProps) {
    return (
        <section
            id="popular"
        ...
        >
            <div className="flex justify-between items-center">
                ...
                <button 
                    onClick={() => handleMovieClick(shuffledLeet[0]?.id)}
            ...
            {shuffledLeet.length === 0 ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                    {shuffledLeet.map((category, index) => (
                        <div
